...
do {
	...
	switch (opcion){
		...
		case 3:
			var multiplica = numero1 * numero2;
			window.alert("La multiplicación es: " + multiplica);
			break;
		case 4:
			var division = numero1 / numero2;
		...
		case 5:
			if (numero1>numero2){
				window.alert("El "+ numero1 + " es mayor que " + numero2);
			}else if(numero1==numero2){
				window.alert( numero1 + " es igual a " + numero2);
			}
			else {
				window.alert("El "+ numero1 + " es menor que " + numero2);
			} 
			break;
		case 6:
			if(numero1>numero2 && numero1>0 && numero2>0){
				...
				window.alert("El resto no exixte");
			}
			break;
		case 0:
			condicion = false;
